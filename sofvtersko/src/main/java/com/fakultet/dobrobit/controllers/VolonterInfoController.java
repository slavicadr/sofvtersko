...
public class VolonterInfoController {
    ...
    // Istaknuti volonteri — sortirani po ocjeni i broju usluga
    @GetMapping("/istaknuti")
    public ResponseEntity<?> istaknuti(@RequestParam(defaultValue = "5") int limit) {
        return ResponseEntity.ok(service.istaknuti(limit));
    }
