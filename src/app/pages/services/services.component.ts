...
export class ServicesComponent implements OnInit {
  ...
  categories = ['Obrazovanje', 'IT', 'Majstorstvo', 'Zdravlje', 'Biznis', 'Prevoz', 'Kuhinja', 'Sport'];
  ...
  allServices = [
    ...
    { id: 6, title: 'Domaći Med (500g)', description: 'Prirodni domaći med sa planinskih pašnjaka. Tegla 500g, sertifikovan.', category: 'Kuhinja', type: 'Proizvod', price: 15, rating: 5.0, reviewCount: 8, volunteerName: 'Janko Pavićević', volunteerInitials: 'PL', beneficiary: 'Porodica Đurić', beneficiaryDesc: 'Obnova doma', icon: '🍯', imageUrl: '', status: 'ACTIVE', reviews: [] },
    ...
    { id: 8, title: 'Časovi njemačkog jezika', description: 'Za sve nivoe.', category: 'Prevoz', type: 'Usluga', price: 10, rating: 4.4, reviewCount: 35, volunteerName: 'Igor Vuković', volunteerInitials: 'IV', beneficiary: 'Porodica Đurić', beneficiaryDesc: 'Obnova doma', icon: '🚗', imageUrl: '', status: 'ACTIVE', reviews: [] },
  ];
