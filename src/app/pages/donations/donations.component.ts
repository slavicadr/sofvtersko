...
export class DonationsComponent implements OnInit {
  ...
  allDonations = [
    { id: 1, donor: 'Srđan Kadić', donorInitials: 'SK', anonymous: false, beneficiary: 'Slaven M.', type: 'Kupovina', description: 'Online Poduka – Matematika', amount: 20, date: '03.06.2026. 09:14' },
    ...
    { id: 5, donor: '', donorInitials: '?', anonymous: true, beneficiary: 'Maja L.', type: 'Kupovina', description: 'Online Poduka – Matematika', amount: 20, date: '01.06.2026. 09:05' },
    ...
    { id: 10, donor: 'Stefan Ilić', donorInitials: 'SI', anonymous: false, beneficiary: 'Marija Nikolić', type: 'Kupovina', description: 'Kurs Meditacije', amount: 35, date: '28.05.2026. 14:15' },
  ];
