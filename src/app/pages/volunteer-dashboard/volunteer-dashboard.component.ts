...
export class VolunteerDashboardComponent implements OnInit {
  ...
  activeOffers = [
    { name: 'Online časovi iz matematike', category: 'Edukacija', price: 20, status: 'ACTIVE',  imageUrl: '' },
  ...
  recentReviews = [
    { buyerName: 'Srđan Kadić',  buyerInitials: 'SK', rating: 5, starsArray: [1,2,3,4,5], emptyStars: [] as number[], comment: 'Profesionalne i zanimljive lekcije. Marko je odličan predavač!', offerName: 'Online časovi iz matematike', date: '02.06.2026.', reply: '', replyOpen: false, replyDraft: '' },
    { buyerName: 'Ana Petrović', buyerInitials: 'AP', rating: 4, starsArray: [1,2,3,4],   emptyStars: [5] as number[], comment: 'Brza i kvalitetna usluga. Računar radi odlično.', offerName: 'Popravka Računara', date: '28.05.2026.', reply: 'Hvala, srećan sam što sam pomogao!', replyOpen: false, replyDraft: '' },
    ...
    { buyerName: 'Nikola Đ.',    buyerInitials: 'NĐ', rating: 3, starsArray: [1,2,3],     emptyStars: [4,5] as number[], comment: 'Solidna usluga, malo duže čekanje na odgovor.', offerName: 'Online časovi iz matematike', date: '10.05.2026.', reply: '', replyOpen: false, replyDraft: '' },
  ];
