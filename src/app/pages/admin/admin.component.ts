...
export class AdminComponent implements OnInit {
  ...
  pendingVolunteersList = [
    { id: 1, name: 'Marija Nikolić',   initials: 'MN', services: 'Astrologija', status: 'PENDING' },
    { id: 2, name: 'Aleksa Kovačević', initials: 'AK', services: 'IT Podrška',           status: 'PENDING' },
    { id: 3, name: 'Jelena Petrović',  initials: 'JP', services: 'Online časovi',        status: 'PENDING' },
  ];
  ...
  // ── Offers ────────────────────────────────────────────────
  allOffers = [
    { id: 1, name: 'Online časovi',        volunteerName: 'Marko Jovanović', category: 'Obrazovanje', beneficiaryName: 'Slaven M.',      price: 20, status: 'ACTIVE',   created: '01.05.2026.', imageUrl: '', emoji: '' },
    ...
    { id: 3, name: 'Biznis savjetovanje',     volunteerName: 'Nikola Stanić',   category: 'Biznis', beneficiaryName: 'Slaven M.',      price: 10, status: 'PENDING',  created: '01.06.2026.', imageUrl: '', emoji: '' },
    { id: 4, name: 'Psihološko savjetovanje.',   volunteerName: 'Petra Lazović',   category: 'Zdravlje',    beneficiaryName: 'Maja L.',        price: 25, status: 'REJECTED', created: '10.04.2026.', imageUrl: '', emoji: '' },
    { id: 5, name: 'Online konsultovanje',    volunteerName: 'Igor Vuković',    category: 'Biznis',      beneficiaryName: 'Porodica Đurić', price: 50, status: 'ACTIVE',   created: '15.03.2026.', imageUrl: '', emoji: '' },
  ];
  offerFilter = 'Sve';
  offerSearch  = '';
  ...
  // ── Transactions ──────────────────────────────────────────
  allTransactions = [
    { id: 'TRX-001', date: '03.06.2026. 09:14', buyerName: 'Srđan Kadić',  offer: 'Online časovi',     beneficiaryName: 'Slaven M.',      amount: 20,  status: 'SUCCESS' },
    { id: 'TRX-002', date: '02.06.2026. 16:45', buyerName: 'Anonimno',     offer: 'IT Podrška',        beneficiaryName: 'Maja L.',        amount: 30,  status: 'SUCCESS' },
    { id: 'TRX-003', date: '02.06.2026. 11:22', buyerName: 'Jovana Radić', offer: 'Online konsultovanje', beneficiaryName: 'Porodica Đurić', amount: 50,  status: 'FAILED'  },
    ...
    { id: 'TRX-005', date: '01.06.2026. 09:05', buyerName: 'Anonimno',     offer: 'Online časovi',     beneficiaryName: 'Maja L.',        amount: 20,  status: 'PENDING' },
  ];
  txSearch       = '';
  txStatusFilter = '';
  txDateFrom     = '';
  ...
  // ── Reviews ───────────────────────────────────────────────
  allReviews = [
    { id: 1, buyerName: 'Srđan K.',  serviceName: 'Online časovi',     rating: 5, starsDisplay: '★★★★★', comment: 'Odlična nastava, preporučujem svima.' },
    { id: 2, buyerName: 'Jovana R.', serviceName: 'IT podrška',        rating: 2, starsDisplay: '★★☆☆☆', comment: 'Kasno se javio, nije riješio problem.'  },
    { id: 3, buyerName: 'Anonimno',  serviceName: 'Online konsultovanje', rating: 4, starsDisplay: '★★★★☆', comment: 'Korisno savjetovanje.'                  },
  ];
